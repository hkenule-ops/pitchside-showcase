...
// Default placeholder images (used when API is not configured)
...
export const fallbackPlayers: Player[] = [
  {
    id: "1", name: "Chukwueze Amadi", position: "Forward", age: 19, jersey: 9,
    image: player1, images: [player1, gallery1, gallery2],
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
    resumeUrl: "https://drive.google.com/file/d/EXAMPLE/preview",
    stats: { goals: 24, assists: 12, appearances: 38, rating: 8.5 },
    bio: "A dynamic forward with incredible pace and finishing ability.", featured: true,
  },
  {
    id: "2", name: "Obinna Nwankwo", position: "Midfielder", age: 20, jersey: 10,
    image: player2, images: [player2, gallery2, gallery3],
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
    stats: { goals: 8, assists: 22, appearances: 40, rating: 8.2 },
    bio: "A creative playmaker with exceptional vision and passing range.", featured: true,
  },
  {
    id: "3", name: "Emeka Okafor", position: "Goalkeeper", age: 18, jersey: 1,
    image: player3, images: [player3, gallery1, gallery3],
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
    stats: { goals: 0, assists: 2, appearances: 35, rating: 7.9 },
    bio: "A commanding presence in goal with lightning reflexes.", featured: true,
  },
];
