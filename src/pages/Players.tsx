      ...
      <div className="pt-24 pb-20 px-4">
        <div className="container mx-auto">
          <h1 className="font-display text-4xl md:text-6xl font-bold uppercase tracking-wider text-center mb-4">
            <span className="text-gradient-primary">Our</span> Players
          </h1>
          <p className="text-center text-muted-foreground text-lg mb-16">Meet the future stars of Nigerian football</p>
